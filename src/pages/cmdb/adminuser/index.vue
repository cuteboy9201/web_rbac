<template>
  <d2-container>
    ...
    >
      ...
      <el-table-column label="登陆用户名" prop="sshUser" :show-overflow-tooltip="true">
        <template slot-scope="scope">{{scope.row.sshUser}}</template>
      </el-table-column>
      <el-table-column label="资产数" prop="nums" :show-overflow-tooltip="true">
        <template slot-scope="scope">{{scope.row.nums}}</template>
      </el-table-column>
      <el-table-column label="可连接数" prop="activeNums" :show-overflow-tooltip="true">
        <template slot-scope="scope">{{scope.row.activeNums}}</template>
      </el-table-column>
      <el-table-column label="不可连接数" prop="disActiveNums" :show-overflow-tooltip="true">
        <template slot-scope="scope">{{scope.row.disActiveNums}}</template>
      </el-table-column>
      <el-table-column label="占比" prop="rank" :show-overflow-tooltip="true">
        <template slot-scope="scope">{{scope.row.rank}}</template>
      </el-table-column>

      <el-table-column label="desc" :show-overflow-tooltip="true" align="center">
