 ...
 * @LastEditTime: 2019-09-19 10:52:03
...
<template>
  <d2-container>
    <el-button-group>
      ...
      <el-button type="primary" icon="el-icon-circle-plus-outline" size="mini" @click="Padd">顶层添加</el-button>
        ...
        <el-card shadow="always">
          <el-form label-position="right" label-width="80px" :model="form" ref="form">
            ...
            <el-form-item label="路径" prop="path">
              <el-autocomplete v-model="form.path" :disabled="!formEdit" :fetch-suggestions="querySearchAsync" placeholder="请选择路径" @select="handleSelect"></el-autocomplete>
            </el-form-item>
